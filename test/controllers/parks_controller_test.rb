...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { employees: @park.employees, location: @park.location, pname: @park.pname, pno: @park.pno } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { employees: @park.employees, location: @park.location, pname: @park.pname, pno: @park.pno } }
