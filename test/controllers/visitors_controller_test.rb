...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { contact: @visitor.contact, noOfTickets: @visitor.noOfTickets, vemail: @visitor.vemail, visitDate: @visitor.visitDate, vname: @visitor.vname } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { contact: @visitor.contact, noOfTickets: @visitor.noOfTickets, vemail: @visitor.vemail, visitDate: @visitor.visitDate, vname: @visitor.vname } }
